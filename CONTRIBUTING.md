...
Thank you for your interest in contributing to Awaaz. This guide covers development setup, code standards, and submission guidelines.
...
- `mypy src/awaaz --strict` must pass (or at least have zero new errors).
