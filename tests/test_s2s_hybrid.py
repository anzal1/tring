...
from awaaz.agent import AgentSpec, ProviderSelection, RuntimeConfig, RuntimeMode, ToolDef
...
from awaaz.providers.base import S2SProvider, TTSChunk, Usage
from awaaz.runtimes.base import AudioFrame
from awaaz.runtimes.hybrid import HybridRuntime
...
def test_cloud_module_registers_expected_provider_names() -> None:
    import awaaz.providers.cloud  # noqa: F401 -- import is the point of the test
    from awaaz.providers import registry
...
async def test_openai_compatible_llm_builds_request_and_parses_usage(
    ...
    from awaaz.providers.cloud import OpenAICompatibleLLM
