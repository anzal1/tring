"""Tests for tring.cost: rate lookup, metering, and reporting.
...
from tring.cost.rates import DEFAULT_RATES, Rate, RateCard
from tring.cost.report import CostReport, denominator_ladder
from tring.events import CostComponent, CostRecorded, SessionEnded
