...
Two quick-start examples showing how to run an awaaz voice agent locally,
...
- Python 3.11+ with awaaz installed

### Setup

```bash
# Install awaaz with local LLM support
pip install -e ".[local]"
...
```bash
# Install awaaz with full local + transport support
