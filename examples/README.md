...
Two quick-start examples showing how to run an tring voice agent locally,
...
- Python 3.11+ with tring installed

### Setup

```bash
# Install tring with local LLM support
pip install -e ".[local]"
...
```bash
# Install tring with full local + transport support
